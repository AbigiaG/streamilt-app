# Correcting the code to avoid refitting the LabelEncoder during prediction
...
def load_model():
    ...
    return clf, label_encoders, X.columns  # Returning model, label encoders, and feature names


# Load model and other components
clf, label_encoders, feature_columns = load_model()
